          ...
          <div className="w-full relative flex justify-between">
            <AniLink
              ...
              className={
                ...
                " text-sm font-bold leading-relaxed inline-block mr-4 py-2 whitespace-no-wrap uppercase text-center"
              }
              to="/"
            >
              <img
            ...
            <div className="justify-end mt-12 ml-12 sm:mt-8 xl:text-8xl">
              <Menu color={"white"} />
            </div>
          </div>
          {/* <div
