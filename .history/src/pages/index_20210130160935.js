  ...
  return (
    <>
      ...
      <main>
        ...
        <section className="pb-20 bg-green-300 -mt-36">
                  ...
                  <ul className="list-none mt-6">
                    <li className="py-2">
                      <div className="flex items-center">
                        <div>
                          <span className="text-xs font-semibold inline-block py-1 px-3 uppercase rounded-full text-white bg-green-300 mr-3">
