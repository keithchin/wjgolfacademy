  ...
  return (
    <>
      ...
      <main>
        ...
        <section className="pb-20 bg-green-600 -mt-32">
          <div className="container mx-auto px-4">
            <div className="flex flex-wrap items-center mt-32">
              ...
              <div className="w-full md:w-4/12 px-4 mr-auto ml-auto mt-16">
                <div
                  className="relative flex flex-col min-w-0 break-words bg-blue-700 w-full mb-6 shadow-lg rounded-lg"
                  data-sal="fade"
            ...
            <div className="items-center flex flex-wrap">
              ...
              >
                <div className="md:pr-12">
                  <h3 className="text-5xl pb-8 mb-8 mt-16 font-bold sm:leading-normal">
                    At WJ Academy, we provide...
                  </h3>
        ...
        <section className="pt-16 sm:mt-0pb-20 relative bg-gray-900">
          <EventsIndex />
        </section>
        <section
