          ...
          <div className="container mx-auto px-4">
            ...
            <div className="flex flex-wrap items-center mt-32">
              <div className="w-full md:w-5/12 px-4 mr-auto ml-auto">
                ...
                <p className="text-white text-lg font-light leading-relaxed mt-4 mb-4 text-gray-700">
                  At WJ Golf Academy, our promise to you is to deliver:
                </p>
                <p className="text-white text-lg font-light leading-relaxed mt-0 mb-4 text-gray-700">
                ...
                <p className="text-white text-lg font-light leading-relaxed mt-0 mb-4 text-gray-700">
                  ✔️ Access to world class golf equipments and facilities
                </p>
              </div>
